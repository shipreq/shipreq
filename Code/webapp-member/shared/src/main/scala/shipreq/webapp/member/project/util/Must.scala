...
/**
 * There exist many cases in which [[shipreq.webapp.member.project.data.DataProp]] has verified the integrity of a
 * [[shipreq.webapp.member.project.data.Project]] yet we have no compiler proof that map lookups will succeed.
 *
