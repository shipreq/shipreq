...
import shipreq.webapp.member.text.GrammarSpec._
...
object Grammar {
  ...
  /** [[shipreq.webapp.member.data.ReqType.Mnemonic]] */
  ...
  /**
   * [[shipreq.webapp.member.data.HashRefKey]]
   *
  ...
  /**
   * [[shipreq.webapp.member.data.ReqCode]]
   *
  ...
  object reqCode {
    ...
    /** Max number of nodes in [[shipreq.webapp.member.data.ReqCode.Value]] */
    def maxNodes = 20
