...
object SavedViewCmd {
  ...
  object CodecsV4 {
    ...
    import shipreq.webapp.member.protocol.binary.v1.BaseMemberData1.SavedViewPicklers._
    import shipreq.webapp.member.protocol.binary.v1.Rev7._
    import shipreq.webapp.member.protocol.binary.v1.Rev7.SavedViewPicklers._
