...
import shipreq.webapp.member.data.derivation.DataLogic.IssueLookup
import shipreq.webapp.member.data.derivation.VirtualProjectTags
import shipreq.webapp.member.data.{FilterDead, HideDead, ShowDead}
import shipreq.webapp.member.issue.Issues
import shipreq.webapp.member.text.{Atom, Grammar, PlainText, TextSearch}
...
object FilterAlgebra {
  ...
  def compile(p          : data.Project,
    ...
    import shipreq.webapp.member.data.{ReqType => _, _}
