...
import shipreq.webapp.member.text.Parsers.{StyleCtx, StyleType}
import shipreq.webapp.member.text.{Atom => A, Parsers => P}
...
//      }
   ...
   * Title of a [[shipreq.webapp.member.data.GenericReq]].
   */
