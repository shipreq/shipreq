...
import shipreq.webapp.member.project.text.Parsers.{StyleCtx, StyleType}
import shipreq.webapp.member.project.text.{Atom => A, Parsers => P}
...
//      }
   ...
   * Title of a [[shipreq.webapp.member.project.data.GenericReq]].
   */
