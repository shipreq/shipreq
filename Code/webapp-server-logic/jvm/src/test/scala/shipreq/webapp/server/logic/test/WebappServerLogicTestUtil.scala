...
trait WebappServerLogicTestEquality extends WebappTestEquality {
...
trait WebappServerLogicTestUtil extends WebappTestUtil {
  import WebappServerLogicTestUtil._

  implicit def toWSTU_IntExt(i: Int) = new WSTU_IntExt(i)
  implicit def toWSTU_DurationExt(d: Duration) = new WSTU_DurationExt(d)
}

object WebappServerLogicTestUtil
  extends WebappServerLogicTestEquality
     with WebappServerLogicTestUtil {
