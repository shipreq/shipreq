...
object B extends Build {
  ...
  implicit class SettingModules(val p: Project) extends AnyVal {

    def addBuildPropertyFileGeneration = {
    ...
    def addIntellijSettings = p.settings(
    ...
    def addTestSettings = p.settings(
    ...
    def addIntegrationTestSettings = p
  ...
  lazy val root =
    ...
    .addBuildPropertyFileGeneration
    .addEclipseSettings
    .addIntellijSettings
    .addJavascriptSettings
    .addTestSettings
    .addIntegrationTestSettings
    .settings(
