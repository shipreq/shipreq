    ...
    'SubmitFeedback - {
      ...
      'req - {
        ...
        'roundTrip - {
          ...
          val genMetadataProject = Gen.apply3(Metadata.Project)(R.projectIdPublic, genOrd.option, genOrd.set(0 to 3))
          val genMetadataClient  = Gen.apply4(Metadata.Client)(genMetadataProject.option, Gen.string, Gen.string, R.username)
        ...
        "v1.0" - {
          "max" - {
            ...
            val projectMetadata = Metadata.Project(Obfuscated("cUZ0"), Some(9), Set(11, 12, 14))
            val metadata        = Metadata.Client(Some(projectMetadata), "https://shipreq.com/project/cUZ0", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36", Username("omg123"))
          ...
          "min" - {
            ...
            val metadata  = Metadata.Client(None, "https://shipreq.com/", "", Username("poop"))
            val expect    = Request(userInput, metadata)
