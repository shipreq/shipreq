...
import shipreq.webapp.member.project.data.StaticField.{ExceptionStepTree => E, NormalAltStepTree => NA}
...
import shipreq.webapp.member.test.project.SampleProject5.{project => project0}
