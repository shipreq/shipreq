...
* Probe exceptions.
* Check candinality limits (eg. if 1..n then what is the max n? If not determined
    by requirements it will be determined by impl capabilities, eg. 32-bit int)
* Check boundaries (like testing).
* Create diagrams.
* Requirements with boolean logic (AND, NOT, OR) should be examined for all
