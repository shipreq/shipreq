...
class FieldSpec[P, V, I, C, O](val p2c: P => C, val v: Validator[I, C, O], val e: Editor[I, V]) {
...
class FieldSpecR[S, R, P, V, I, C, O](s: FieldSpec[P, V, I, C, O], val vr: Option[ValidateFnR[S, R, O]])
