...
object SpecN {
  ...
  final case class RowSpec1[S, W, G, P, V, I1: Equal,C1,O1](s1: FieldSpecW[S,W,P,V,I1,C1,O1], oo2g: (O1) ⇒ G)
      extends RowSpec[S, W, G, P, I1, V] {

    override def initial(p: P): I1 = s1 initial p

    private def fieldRenderers[M[_] : Bind : Optional2](
        s2mp: S ⇒ M[P], w: W, saveG: (S, G) ⇒ IO[S], eL: WeirdLens[M,S,S,I1]) = {
  ...
  final case class RowSpec2[S, W, G, P, V, I1: Equal,C1,O1, I2: Equal,C2,O2](s1: FieldSpecW[S,W,P,V,I1,C1,O1], s2: FieldSpecW[S,W,P,V,I2,C2,O2], oo2g: ((O1,O2)) ⇒ G)
      extends RowSpec[S, W, G, P, (I1,I2), (V,V)] {

    override def initial(p: P): (I1,I2) = (s1 initial p,s2 initial p)

    private def fieldRenderers[M[_] : Bind : Optional2](
        s2mp: S ⇒ M[P], w: W, saveG: (S, G) ⇒ IO[S], eL: WeirdLens[M,S,S,(I1,I2)]) = {
  ...
  final case class RowSpec3[S, W, G, P, V, I1: Equal,C1,O1, I2: Equal,C2,O2, I3: Equal,C3,O3](s1: FieldSpecW[S,W,P,V,I1,C1,O1], s2: FieldSpecW[S,W,P,V,I2,C2,O2], s3: FieldSpecW[S,W,P,V,I3,C3,O3], oo2g: ((O1,O2,O3)) ⇒ G)
      extends RowSpec[S, W, G, P, (I1,I2,I3), (V,V,V)] {

    override def initial(p: P): (I1,I2,I3) = (s1 initial p,s2 initial p,s3 initial p)

    private def fieldRenderers[M[_] : Bind : Optional2](
        s2mp: S ⇒ M[P], w: W, saveG: (S, G) ⇒ IO[S], eL: WeirdLens[M,S,S,(I1,I2,I3)]) = {
  ...
  final case class RowSpec4[S, W, G, P, V, I1: Equal,C1,O1, I2: Equal,C2,O2, I3: Equal,C3,O3, I4: Equal,C4,O4](s1: FieldSpecW[S,W,P,V,I1,C1,O1], s2: FieldSpecW[S,W,P,V,I2,C2,O2], s3: FieldSpecW[S,W,P,V,I3,C3,O3], s4: FieldSpecW[S,W,P,V,I4,C4,O4], oo2g: ((O1,O2,O3,O4)) ⇒ G)
      extends RowSpec[S, W, G, P, (I1,I2,I3,I4), (V,V,V,V)] {

    override def initial(p: P): (I1,I2,I3,I4) = (s1 initial p,s2 initial p,s3 initial p,s4 initial p)

    private def fieldRenderers[M[_] : Bind : Optional2](
        s2mp: S ⇒ M[P], w: W, saveG: (S, G) ⇒ IO[S], eL: WeirdLens[M,S,S,(I1,I2,I3,I4)]) = {
  ...
  final case class RowSpec5[S, W, G, P, V, I1: Equal,C1,O1, I2: Equal,C2,O2, I3: Equal,C3,O3, I4: Equal,C4,O4, I5: Equal,C5,O5](s1: FieldSpecW[S,W,P,V,I1,C1,O1], s2: FieldSpecW[S,W,P,V,I2,C2,O2], s3: FieldSpecW[S,W,P,V,I3,C3,O3], s4: FieldSpecW[S,W,P,V,I4,C4,O4], s5: FieldSpecW[S,W,P,V,I5,C5,O5], oo2g: ((O1,O2,O3,O4,O5)) ⇒ G)
      extends RowSpec[S, W, G, P, (I1,I2,I3,I4,I5), (V,V,V,V,V)] {

    override def initial(p: P): (I1,I2,I3,I4,I5) = (s1 initial p,s2 initial p,s3 initial p,s4 initial p,s5 initial p)

    private def fieldRenderers[M[_] : Bind : Optional2](
        s2mp: S ⇒ M[P], w: W, saveG: (S, G) ⇒ IO[S], eL: WeirdLens[M,S,S,(I1,I2,I3,I4,I5)]) = {
  ...
  final case class RowSpec7[S, W, G, P, V, I1: Equal,C1,O1, I2: Equal,C2,O2, I3: Equal,C3,O3, I4: Equal,C4,O4, I5: Equal,C5,O5, I6: Equal,C6,O6, I7: Equal,C7,O7](s1: FieldSpecW[S,W,P,V,I1,C1,O1], s2: FieldSpecW[S,W,P,V,I2,C2,O2], s3: FieldSpecW[S,W,P,V,I3,C3,O3], s4: FieldSpecW[S,W,P,V,I4,C4,O4], s5: FieldSpecW[S,W,P,V,I5,C5,O5], s6: FieldSpecW[S,W,P,V,I6,C6,O6], s7: FieldSpecW[S,W,P,V,I7,C7,O7], oo2g: ((O1,O2,O3,O4,O5,O6,O7)) ⇒ G)
    ...
    private def fieldRenderers[M[_] : Bind : Optional2](
        s2mp: S ⇒ M[P], w: W, saveG: (S, G) ⇒ IO[S], eL: WeirdLens[M,S,S,(I1,I2,I3,I4,I5,I6,I7)]) = {
  ...
  final case class RowSpec8[S, W, G, P, V, I1: Equal,C1,O1, I2: Equal,C2,O2, I3: Equal,C3,O3, I4: Equal,C4,O4, I5: Equal,C5,O5, I6: Equal,C6,O6, I7: Equal,C7,O7, I8: Equal,C8,O8](s1: FieldSpecW[S,W,P,V,I1,C1,O1], s2: FieldSpecW[S,W,P,V,I2,C2,O2], s3: FieldSpecW[S,W,P,V,I3,C3,O3], s4: FieldSpecW[S,W,P,V,I4,C4,O4], s5: FieldSpecW[S,W,P,V,I5,C5,O5], s6: FieldSpecW[S,W,P,V,I6,C6,O6], s7: FieldSpecW[S,W,P,V,I7,C7,O7], s8: FieldSpecW[S,W,P,V,I8,C8,O8], oo2g: ((O1,O2,O3,O4,O5,O6,O7,O8)) ⇒ G)
    ...
    private def fieldRenderers[M[_] : Bind : Optional2](
        s2mp: S ⇒ M[P], w: W, saveG: (S, G) ⇒ IO[S], eL: WeirdLens[M,S,S,(I1,I2,I3,I4,I5,I6,I7,I8)]) = {
  ...
  final case class RowSpec9[S, W, G, P, V, I1: Equal,C1,O1, I2: Equal,C2,O2, I3: Equal,C3,O3, I4: Equal,C4,O4, I5: Equal,C5,O5, I6: Equal,C6,O6, I7: Equal,C7,O7, I8: Equal,C8,O8, I9: Equal,C9,O9](s1: FieldSpecW[S,W,P,V,I1,C1,O1], s2: FieldSpecW[S,W,P,V,I2,C2,O2], s3: FieldSpecW[S,W,P,V,I3,C3,O3], s4: FieldSpecW[S,W,P,V,I4,C4,O4], s5: FieldSpecW[S,W,P,V,I5,C5,O5], s6: FieldSpecW[S,W,P,V,I6,C6,O6], s7: FieldSpecW[S,W,P,V,I7,C7,O7], s8: FieldSpecW[S,W,P,V,I8,C8,O8], s9: FieldSpecW[S,W,P,V,I9,C9,O9], oo2g: ((O1,O2,O3,O4,O5,O6,O7,O8,O9)) ⇒ G)
    ...
    private def fieldRenderers[M[_] : Bind : Optional2](
        s2mp: S ⇒ M[P], w: W, saveG: (S, G) ⇒ IO[S], eL: WeirdLens[M,S,S,(I1,I2,I3,I4,I5,I6,I7,I8,I9)]) = {
